...
>In the context of this document, `KUBERNETES_HOME` will refer to a local copy of the [`wso2/kubernetes-is`](https://github.com/wso2/kubernetes-advance/is/)
Git repository.<br>
...
* You can use Kubernetes resources provided in the directory `KUBERNETES_HOME/advance/is/extras/rdbms/mysql`
...
* For using these Kubernetes resources,
  ...
  NFS server directory path (`NFS_LOCATION_PATH`) in `<KUBERNETES_HOME>/advance/is/extras/rdbms/volumes/persistent-volumes.yaml`.
...
* Setup the external product databases. Please refer to WSO2 Identity Server's [official documentation](https://docs.wso2.com/display/IS550/Setting+Up+Separate+Databases+for+Clustering)
  ...
  * `<KUBERNETES_HOME>/advance/is/confs/advance/is/datasources/master-datasources.xml`
  * `<KUBERNETES_HOME>/advance/is/confs/advance/is/datasources/bps-datasources.xml`
  
  Please refer WSO2's [official documentation](https://docs.wso2.com/display/ADMIN44x/Configuring+master-datasources.xml) on configuring data sources.
  
##### 5. Deploy Kubernetes resources:

Change directory to `<KUBERNETES_HOME>/advance/is/scripts` and execute the `deploy.sh` shell script on the terminal, with the appropriate configurations as follows:
