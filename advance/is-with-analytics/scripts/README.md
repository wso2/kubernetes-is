...
* You can use Kubernetes resources provided in the directory `KUBERNETES_HOME/advance/is-with-analytics/extras/rdbms/mysql`
...
Change directory to `<KUBERNETES_HOME>/advance/is-with-analytics/scripts` and execute the `deploy.sh` shell script on the terminal, with the appropriate configurations as follows:
