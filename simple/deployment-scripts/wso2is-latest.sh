...
function deploy(){
    ...
    kubectl delete secret wso2is-deployment-creds --ignore-not-found=true
    kubectl create secret docker-registry wso2is-deployment-creds --docker-server="docker.wso2.com" --docker-username="$WSO2_SUBSCRIPTION_USERNAME" --docker-password="$WSO2_SUBSCRIPTION_PASSWORD" --docker-email="$WSO2_SUBSCRIPTION_USERNAME"
