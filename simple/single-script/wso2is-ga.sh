...
function progress_bar(){
  ...
  do
      ...
      if [[ $time_proc -gt 250 ]]
      then
          echoBold "\nSomething went wrong! Please Follow \"https://docs.google.com/document/d/1c9TS2R9U0lcBHxqUbgcWR72uutPHBjFE9J_y7qOvomY/edit?usp=sharing\" for more information\n"
          exit 2
      fi
  done
