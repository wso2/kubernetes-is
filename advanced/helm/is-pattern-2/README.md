...
b. Open the `<HELM_HOME>/is-pattern-2/values.yaml` and provide the following values. If you do not have an active 
...
##### 4. Deploy WSO2 Identity Server with WSO2 Identity Server Analytics.
