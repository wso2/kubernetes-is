...
* You can use Kubernetes resources provided in the directory `<KUBERNETES_HOME>/advanced/is/extras/rdbms/mysql`
...
* For using these Kubernetes resources,
  ...
  NFS server directory path (`NFS_LOCATION_PATH`) in `<KUBERNETES_HOME>/advanced/is/extras/rdbms/volumes/persistent-volumes.yaml`.
...
* Setup the external product databases. Please refer to WSO2 Identity Server's [official documentation](https://docs.wso2.com/display/IS550/Setting+Up+Separate+Databases+for+Clustering)
  ...
  * `<KUBERNETES_HOME>/advanced/is/confs/datasources/master-datasources.xml`
  * `<KUBERNETES_HOME>/advanced/is/confs/datasources/bps-datasources.xml`
  
  Please refer WSO2's [official documentation](https://docs.wso2.com/display/ADMIN44x/Configuring+master-datasources.xml) on configuring data sources.
  
##### 5. Deploy Kubernetes resources:

Change directory to `<KUBERNETES_HOME>/advanced/is/scripts` and execute the `deploy.sh` shell script on the terminal, with the appropriate configurations as follows:
