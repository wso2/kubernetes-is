...
DROP DATABASE IF EXISTS WSO2_STAT_DB;
...
GRANT ALL ON WSO2IS_REG_DB.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
...
GRANT ALL ON WSO2_STAT_DB.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
