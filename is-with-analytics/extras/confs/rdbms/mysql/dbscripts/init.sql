...
DROP DATABASE IF EXISTS WSO2IS_COMMON_DB;
...
CREATE DATABASE WSO2IS_COMMON_DB;
...
GRANT ALL ON WSO2IS_COMMON_DB.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
