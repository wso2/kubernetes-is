...
DROP DATABASE IF EXISTS WSO2IS_CONFIG_REG_DB;
DROP DATABASE IF EXISTS WSO2IS_GOV_REG_DB;
DROP DATABASE IF EXISTS WSO2IS_BPS_DB;

CREATE DATABASE WSO2IS_USER_DB;
CREATE DATABASE WSO2IS_IDENTITY_DB;
CREATE DATABASE WSO2IS_CONFIG_REG_DB;
CREATE DATABASE WSO2IS_GOV_REG_DB;
...
GRANT ALL ON WSO2IS_CONFIG_REG_DB.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
GRANT ALL ON WSO2IS_GOV_REG_DB.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
